...
|-----------|----------|---------|
| CBV_CONFIG.ADMIN_EMAILS | 00_CORE_CONFIG.js | Array of email strings. Required for admin ops. |
| assertAdminAuthority() | 00_CORE_UTILS.js | Throws if cbvUser() not in ADMIN_EMAILS or if ADMIN_EMAILS empty. |
| isAdminUser() | 00_CORE_UTILS.js | Returns true if cbvUser() in ADMIN_EMAILS. |
...
- When ADMIN_EMAILS is undefined or empty: assertAdminAuthority() throws. Message: "Admin operations require CBV_CONFIG.ADMIN_EMAILS. Add admin email(s) to 00_CORE_CONFIG.js."
