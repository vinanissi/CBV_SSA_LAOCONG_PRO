...
Full mapping in `05_GAS_RUNTIME/03_SHARED_ROW_READER.js` → `CBV_MEANINGFUL_FIELDS`.
...
- **Implementation**: `05_GAS_RUNTIME/03_SHARED_ROW_READER.js`
- **Load order**: After `02_USER_SERVICE.js`, before `03_SHARED_REPOSITORY.js` (`.clasp.json` filePushOrder)
