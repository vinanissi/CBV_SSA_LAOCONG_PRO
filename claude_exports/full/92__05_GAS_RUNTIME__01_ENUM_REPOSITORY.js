 ...
 * Fallback to CBV_ENUM (00_CORE_CONSTANTS.js) if sheet missing or not initialized.
 */
var _enumCache = null;
 ...
 * Uses CBV_ENUM from 00_CORE_CONSTANTS.js. Maps group names to arrays.
 */
function _getFallbackEnumMap() {
  ...
  var fallback = {
    ...
    USER_DIRECTORY_STATUS: CBV_ENUM.USER_DIRECTORY_STATUS || [],
