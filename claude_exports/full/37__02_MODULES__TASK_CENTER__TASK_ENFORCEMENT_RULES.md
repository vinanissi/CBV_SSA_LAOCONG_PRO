...
| Rule | Enforcement |
|------|-------------|
| All TASK_* writes via service | Only `20_TASK_SERVICE.js` and `03_SHARED_REPOSITORY.js` call `_appendRecord` / `_updateRow` on TASK_MAIN, TASK_CHECKLIST, TASK_ATTACHMENT, TASK_UPDATE_LOG |
