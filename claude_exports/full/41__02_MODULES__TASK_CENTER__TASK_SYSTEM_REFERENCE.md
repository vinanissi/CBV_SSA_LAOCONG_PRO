...
| File | Role |
|------|------|
| 20_TASK_REPOSITORY.js | Low-level: taskFindById, taskAppendMain, taskUpdateMain, taskAppendChecklist, taskAppendAttachment, taskAppendUpdateLog |
| 20_TASK_VALIDATION.js | Guards: assertActiveHtxId, validateTaskTransition, ensureTaskEditable, ensureTaskCanComplete |
| 20_TASK_SERVICE.js | Public API: createTask, updateTask, assignTask, setTaskStatus, completeTask, cancelTask, addChecklistItem, markChecklistDone, addTaskAttachment, addTaskUpdateLog |
| 20_TASK_MIGRATION_HELPER.js | Migration: analyzeTaskMigrationSource, buildTaskMigrationReport, runTaskMigration |
| 90_BOOTSTRAP_TASK.js | taskBootstrapSheets() — ensures TASK sheets exist |
