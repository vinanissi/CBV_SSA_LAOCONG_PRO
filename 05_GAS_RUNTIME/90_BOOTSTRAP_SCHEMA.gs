...
const CBV_SCHEMA_MANIFEST = {
  ...
  HO_SO_MASTER: ['ID', 'HO_SO_TYPE', 'CODE', 'NAME', 'HO_SO_CODE', 'TITLE', 'DISPLAY_NAME', 'HO_SO_TYPE_ID', 'STATUS', 'DON_VI_ID', 'OWNER_ID', 'HTX_ID', 'MANAGER_USER_ID', 'RELATED_ENTITY_TYPE', 'RELATED_ENTITY_ID', 'FULL_NAME', 'PHONE', 'EMAIL', 'ID_TYPE', 'ID_NO', 'DOB', 'ADDRESS', 'START_DATE', 'END_DATE', 'PRIORITY', 'SOURCE_CHANNEL', 'SUMMARY', 'NOTE', 'TAGS', 'IS_STARRED', 'IS_PINNED', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
