...
function CbvUiContract__baselineSeedRows_(actor, now) {
  ...
  return [
    haRow('UIC_HOME_ALERT_OPERATOR_DASHBOARD', 'HOME_ALERT_OPERATOR_DASHBOARD', 'HOME_ALERT — Operator dashboard', 'BOTH', 'DASHBOARD',
      ...
      'Row-level security filter must respect role + assignment; use USEREMAIL() and USERSETTINGS("Role"); do not use legacy AppSheet row-user tokens.'),
    ...
    },
    {
      ...
      SECONDARY_TEXT_FIELD: 'ENUM_LABEL',
