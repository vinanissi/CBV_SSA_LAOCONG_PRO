...
var ENUM_REPO_VALUES = {
  ...
  UPDATE_TYPE: ['CREATED', 'STATUS_CHANGED', 'CHECKLIST_ADDED', 'CHECKLIST_DONE', 'COMMENT'],
...
function auditEnumConsistency() {
  ...
  var requiredGroups = ['HO_SO_TYPE', 'HO_SO_STATUS', 'FILE_GROUP', 'TASK_TYPE', 'TASK_STATUS', 'TASK_PRIORITY', 'ATTACHMENT_TYPE', 'UPDATE_TYPE', 'FINANCE_TYPE', 'FINANCE_STATUS', 'FIN_CATEGORY', 'PAYMENT_METHOD', 'MASTER_CODE_STATUS', 'RELATED_ENTITY_TYPE'];
