...
var CBV_AUDIT_SCHEMA = {
  ...
  CBV_UI_CONTRACT: {
    requiredColumns: ['UI_CONTRACT_ID', 'SCREEN_CODE', 'CHANNEL', 'SCREEN_TYPE', 'IS_ENABLED'],
    optionalColumns: [
      'SCREEN_NAME', 'MODULE_CODE', 'DOMAIN_CODE', 'USER_ROLE', 'TEAM_CODE', 'DATA_SOURCE_SHEET', 'DATA_SOURCE_VIEW',
      'PRIMARY_KEY_FIELD', 'PRIMARY_TEXT_FIELD', 'SECONDARY_TEXT_FIELD', 'META_TEXT_FIELD', 'NEXT_ACTION_FIELD',
      'GROUP_BY_FIELD', 'SORT_BY_FIELD', 'SORT_DIRECTION', 'WEBAPP_ROUTE', 'APPSHEET_VIEW', 'APPSHEET_DEEPLINK_EXPR',
      'ALLOWED_ACTIONS_JSON', 'PERMISSION_RULE_CODE', 'SECURITY_FILTER_HINT', 'SLA_BADGE_FIELD', 'STATUS_FIELD',
      'PRIORITY_FIELD', 'IS_PILOT_READY', 'DISPLAY_ORDER', 'NOTES', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'CONTRACT_VERSION'
    ],
    key: 'UI_CONTRACT_ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
    refColumns: {},
