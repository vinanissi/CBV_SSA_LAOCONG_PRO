...
var CBV_AUDIT_SCHEMA = {
  ...
  HO_SO_MASTER: {
    ...
    optionalColumns: ['CODE', 'HO_SO_CODE', 'TITLE', 'DISPLAY_NAME', 'HO_SO_TYPE_ID', 'DON_VI_ID', 'OWNER_ID', 'HTX_ID', 'MANAGER_USER_ID', 'RELATED_ENTITY_TYPE', 'RELATED_ENTITY_ID', 'FULL_NAME', 'PHONE', 'EMAIL', 'ID_TYPE', 'ID_NO', 'DOB', 'ADDRESS', 'START_DATE', 'END_DATE', 'PRIORITY', 'SOURCE_CHANNEL', 'SUMMARY', 'NOTE', 'TAGS', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_STARRED', 'IS_PINNED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
  ...
  TASK_MAIN: {
    ...
    optionalColumns: ['TASK_CODE', 'DESCRIPTION', 'TASK_TYPE_ID', 'REPORTER_ID', 'SHARED_WITH', 'IS_PRIVATE', 'RELATED_ENTITY_TYPE', 'RELATED_ENTITY_ID', 'START_DATE', 'DUE_DATE', 'DONE_AT', 'PROGRESS_PERCENT', 'RESULT_SUMMARY', 'PENDING_ACTION', 'IS_STARRED', 'IS_PINNED', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
  ...
  TASK_UPDATE_LOG: {
    ...
    optionalColumns: ['ACTION', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
  ...
  TASK_ATTACHMENT: {
    ...
    optionalColumns: ['ATTACHMENT_TYPE', 'TITLE', 'FILE_URL', 'DRIVE_FILE_ID', 'SOURCE_MODE', 'FILE_NAME', 'UPLOAD_FILE', 'FILE_EXT', 'LINK_DOMAIN', 'SORT_ORDER', 'STATUS', 'NOTE', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
  ...
  FINANCE_TRANSACTION: {
    ...
    optionalColumns: ['TRANS_CODE', 'TRANS_DATE', 'TRANS_TYPE', 'CATEGORY', 'DON_VI_ID', 'COUNTERPARTY', 'PAYMENT_METHOD', 'REFERENCE_NO', 'RELATED_ENTITY_TYPE', 'RELATED_ENTITY_ID', 'DESCRIPTION', 'EVIDENCE_URL', 'IS_STARRED', 'IS_PINNED', 'PENDING_ACTION', 'CONFIRMED_AT', 'CONFIRMED_BY', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
    workflowColumns: ['STATUS', 'PENDING_ACTION', 'CONFIRMED_AT', 'CONFIRMED_BY'],
  ...
  DOC_REQUIREMENT: {
    requiredColumns: ['ID', 'HO_SO_TYPE', 'DOC_TYPE'],
    optionalColumns: ['IS_REQUIRED', 'VALID_MONTHS', 'DESCRIPTION', 'SORT_ORDER', 'IS_ACTIVE', 'NOTE', 'CREATED_AT', 'CREATED_BY'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY'],
    refColumns: {},
    enumColumns: {}
