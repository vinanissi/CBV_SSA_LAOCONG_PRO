...
var CBV_MEANINGFUL_FIELDS = {
  ...
  HO_SO_RELATION: ['ID', 'FROM_HO_SO_ID', 'TO_HO_SO_ID', 'RELATED_TABLE', 'RELATED_RECORD_ID', 'RELATION_TYPE', 'NOTE'],
  HO_SO_DETAIL_PHUONG_TIEN: ['ID', 'HO_SO_ID', 'HTX_ID', 'PLATE_NO', 'VEHICLE_TYPE_ID', 'VIN', 'CAPACITY_TON', 'NOTE'],
  ...
  FINANCE_TRANSACTION: ['ID', 'TRANS_CODE', 'TRANS_DATE', 'TRANS_TYPE', 'STATUS', 'CATEGORY', 'AMOUNT', 'DON_VI_ID', 'COUNTERPARTY', 'PAYMENT_METHOD', 'REFERENCE_NO', 'RELATED_ENTITY_TYPE', 'RELATED_ENTITY_ID', 'DESCRIPTION', 'EVIDENCE_URL', 'CONFIRMED_AT', 'CONFIRMED_BY', 'IS_STARRED', 'IS_PINNED', 'PENDING_ACTION'],
  FIN_EXPORT_FILTER: ['ID', 'USER_EMAIL', 'DATE_FROM', 'DATE_TO', 'DON_VI_ID', 'USER_REF_ID', 'NOTE'],
