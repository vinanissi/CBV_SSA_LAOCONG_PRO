...
var CBV_MEANINGFUL_FIELDS = {
  ...
  ENUM_DICTIONARY: ['ID', 'ENUM_GROUP', 'ENUM_VALUE', 'ENUM_CODE', 'DISPLAY_TEXT', 'ENUM_LABEL', 'SORT_ORDER', 'IS_ACTIVE', 'NOTE'],
  ...
  HO_SO_MASTER: ['ID', 'HO_SO_CODE', 'TITLE', 'DISPLAY_NAME', 'HO_SO_TYPE_ID', 'STATUS', 'DON_VI_ID', 'OWNER_ID', 'MANAGER_USER_ID', 'RELATED_ENTITY_TYPE', 'RELATED_ENTITY_ID', 'FULL_NAME', 'PHONE', 'EMAIL', 'ID_TYPE', 'ID_NO', 'DOB', 'ADDRESS', 'START_DATE', 'END_DATE', 'PRIORITY', 'SOURCE_CHANNEL', 'SUMMARY', 'NOTE', 'TAGS_TEXT', 'IS_STARRED', 'IS_PINNED', 'PENDING_ACTION'],
  HO_SO_FILE: ['ID', 'HO_SO_ID', 'FILE_TYPE', 'TITLE', 'FILE_NAME', 'FILE_URL', 'DRIVE_FILE_ID', 'MIME_TYPE', 'FILE_SIZE', 'VERSION_NO', 'ISSUED_DATE', 'EXPIRED_DATE', 'NOTE'],
  HO_SO_RELATION: ['ID', 'HO_SO_ID', 'RELATED_TABLE', 'RELATED_RECORD_ID', 'RELATION_TYPE', 'NOTE'],
  HO_SO_UPDATE_LOG: ['ID', 'HO_SO_ID', 'ACTION_TYPE', 'OLD_STATUS', 'NEW_STATUS', 'FIELD_CHANGED', 'OLD_VALUE', 'NEW_VALUE', 'NOTE', 'ACTOR_ID'],
  ...
  TEAM_DIRECTORY: ['TEAM_ID', 'TEAM_CODE', 'TEAM_NAME', 'DON_VI_ID', 'SUPERVISOR_ID', 'TEAM_TYPE', 'DEFAULT_QUEUE', 'STATUS'],
  ROLE_PERMISSION_MATRIX: ['PERMISSION_ID', 'ROLE_CODE', 'ACTION_CODE', 'MODULE_CODE', 'RESOURCE_TYPE', 'CAN_EXECUTE'],
  FEATURE_FLAG: ['FEATURE_ID', 'FEATURE_CODE', 'MODULE_CODE', 'FEATURE_NAME', 'ENABLED', 'STATUS'],
  SYSTEM_REGISTRY: ['REGISTRY_ID', 'REGISTRY_TYPE', 'REGISTRY_CODE', 'MODULE_CODE', 'RESOURCE_NAME', 'RESOURCE_REF', 'STATUS']
};
