...
var CBV_WEBAPP_VI_ROUTE_PAGE_TITLE = {
  ...
  '/workboard': 'Báo việc',
  '/workspace/workboard/tasks': 'Workboard — Danh sách việc',
  '/workboard/tasks': 'Danh sách việc',
  '/workspace/workboard/task-detail': 'Workboard — Chi tiết việc',
  '/workboard/task-detail': 'Chi tiết việc',
  '/workspace/workboard/search': 'Workboard — Tìm kiếm',
  '/workboard/search': 'Tìm kiếm',
  '/workspace/workboard/notifications': 'Workboard — Thông báo',
  '/workboard/notifications': 'Thông báo',
  '/workspace/workboard/files': 'Workboard — File',
  '/workboard/files': 'File',
  '/workspace/coordination': 'Điều phối vận hành',
  '/workboard/coordination': 'Điều phối',
  '/workspace/coordination/manager': 'Điều phối — Quản lý',
  '/workspace/coordination/queue': 'Queue vận hành',
  '/workboard/queue': 'Queue',
  '/workspace/coordination/overdue': 'Việc quá hạn',
  '/workboard/overdue': 'Quá hạn',
  '/workspace/coordination/workload': 'Tải nhân sự',
  '/workboard/workload': 'Tải NV',
  '/workspace/coordination/assignment': 'Giao việc',
  '/workboard/assignment': 'Giao việc',
  '/workspace/observation': 'Quan sát vận hành',
  '/workboard/observation': 'Quan sát',
  '/workspace/observation/health': 'Runtime Health',
  '/workboard/health': 'Health',
  '/workspace/observation/projections': 'Projection Health',
  '/workspace/observation/queues': 'Queue Health',
  '/workspace/observation/sync': 'Sync Health',
  '/workspace/observation/audit': 'Audit Feed',
  '/workboard/audit': 'Audit',
  '/workspace/observation/alerts': 'Cảnh báo vận hành',
  '/workboard/alerts': 'Cảnh báo',
  '/workspace/plugins': 'Module Plugin',
  '/workboard/plugins': 'Module',
  '/workspace/plugins/task': 'Task Plugin',
  '/workboard/plugin-task': 'Task Plugin',
  '/workspace/plugins/finance': 'Finance Plugin',
  '/workspace/plugins/finance/items': 'Finance — Danh sách',
  '/workspace/plugins/finance/alerts': 'Finance — Cảnh báo',
  '/workspace/plugins/finance/search': 'Finance — Tìm kiếm',
  '/workboard/plugin-finance': 'Finance Plugin',
  '/workspace/plugins/ho-so': 'Hồ sơ Plugin',
  '/workspace/plugins/ho-so/items': 'Hồ sơ — Danh sách',
  '/workspace/plugins/ho-so/alerts': 'Hồ sơ — Cảnh báo',
  '/workspace/plugins/ho-so/search': 'Hồ sơ — Tìm kiếm',
  '/workboard/plugin-ho-so': 'Hồ sơ Plugin',
  '/workspace/plugins/health': 'Plugin Health',
