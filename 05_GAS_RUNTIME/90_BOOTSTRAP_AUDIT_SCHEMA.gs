...
var CBV_AUDIT_SCHEMA = {
  USER_DIRECTORY: {
    ...
    optionalColumns: ['DISPLAY_NAME', 'EMAIL', 'PHONE', 'POSITION', 'HTX_ID', 'NOTE', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
    refColumns: { HTX_ID: 'HO_SO_MASTER' },
  ...
  MASTER_CODE: {
    ...
    optionalColumns: ['NAME', 'DISPLAY_TEXT', 'SHORT_NAME', 'PARENT_CODE', 'SORT_ORDER', 'IS_SYSTEM', 'ALLOW_EDIT', 'NOTE', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
    refColumns: {},
  ...
  HO_SO_MASTER: {
    requiredColumns: ['ID', 'HO_SO_TYPE', 'NAME', 'STATUS'],
    optionalColumns: ['CODE', 'HTX_ID', 'OWNER_ID', 'PHONE', 'EMAIL', 'ID_NO', 'ADDRESS', 'START_DATE', 'END_DATE', 'NOTE', 'TAGS', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
    refColumns: { HTX_ID: 'HO_SO_MASTER', OWNER_ID: 'USER_DIRECTORY' },
    enumColumns: { HO_SO_TYPE: 'HO_SO_TYPE', STATUS: 'HO_SO_STATUS' }
  },
  HO_SO_FILE: {
    requiredColumns: ['ID', 'HO_SO_ID', 'FILE_GROUP'],
    optionalColumns: ['FILE_NAME', 'FILE_URL', 'DRIVE_FILE_ID', 'STATUS', 'NOTE', 'CREATED_AT', 'CREATED_BY'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY'],
    refColumns: { HO_SO_ID: 'HO_SO_MASTER' },
    enumColumns: { FILE_GROUP: 'FILE_GROUP' }
  },
  HO_SO_RELATION: {
    requiredColumns: ['ID', 'FROM_HO_SO_ID', 'TO_HO_SO_ID', 'RELATION_TYPE', 'STATUS'],
    optionalColumns: ['START_DATE', 'END_DATE', 'NOTE', 'CREATED_AT', 'CREATED_BY'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY'],
  ...
  TASK_MAIN: {
    requiredColumns: ['ID', 'TITLE', 'TASK_TYPE', 'STATUS', 'PRIORITY', 'HTX_ID', 'OWNER_ID'],
    optionalColumns: ['TASK_CODE', 'DESCRIPTION', 'REPORTER_ID', 'RELATED_ENTITY_TYPE', 'RELATED_ENTITY_ID', 'START_DATE', 'DUE_DATE', 'DONE_AT', 'PROGRESS_PERCENT', 'RESULT_SUMMARY', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
    workflowColumns: ['STATUS', 'DONE_AT', 'PROGRESS_PERCENT'],
    refColumns: { HTX_ID: 'HO_SO_MASTER', OWNER_ID: 'USER_DIRECTORY', REPORTER_ID: 'USER_DIRECTORY' },
    enumColumns: { TASK_TYPE: 'TASK_TYPE', STATUS: 'TASK_STATUS', PRIORITY: 'TASK_PRIORITY', RELATED_ENTITY_TYPE: 'RELATED_ENTITY_TYPE' }
  },
  TASK_CHECKLIST: {
    requiredColumns: ['ID', 'TASK_ID', 'TITLE'],
    optionalColumns: ['ITEM_NO', 'DESCRIPTION', 'IS_REQUIRED', 'IS_DONE', 'DONE_AT', 'DONE_BY', 'NOTE', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
  ...
  FINANCE_TRANSACTION: {
    ...
    optionalColumns: ['TRANS_CODE', 'TRANS_DATE', 'TRANS_TYPE', 'CATEGORY', 'UNIT_ID', 'COUNTERPARTY', 'PAYMENT_METHOD', 'REFERENCE_NO', 'RELATED_ENTITY_TYPE', 'RELATED_ENTITY_ID', 'DESCRIPTION', 'EVIDENCE_URL', 'CONFIRMED_AT', 'CONFIRMED_BY', 'CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY', 'IS_DELETED'],
    key: 'ID',
    auditColumns: ['CREATED_AT', 'CREATED_BY', 'UPDATED_AT', 'UPDATED_BY'],
    workflowColumns: ['STATUS', 'CONFIRMED_AT', 'CONFIRMED_BY'],
    refColumns: { UNIT_ID: 'MASTER_CODE', CONFIRMED_BY: 'USER_DIRECTORY' },
...
var CBV_AUDIT_REFS = [
  { child: 'TASK_MAIN', childCol: 'HTX_ID', parent: 'HO_SO_MASTER', parentKey: 'ID' },
...
var CBV_SOFT_DELETE_TABLES = ['USER_DIRECTORY', 'MASTER_CODE', 'HO_SO_MASTER', 'TASK_MAIN', 'TASK_CHECKLIST', 'TASK_ATTACHMENT', 'TASK_UPDATE_LOG', 'FINANCE_TRANSACTION'];
