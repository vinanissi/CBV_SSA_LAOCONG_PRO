...
function buildCbvTestConsoleMenu_() {
  ...
  ui.createMenu('🧪 CBV Test Console')
    ...
    .addItem('Run Milestone 04 Operation Execution Flow Test', 'menuCbvTestConsoleMilestone04_runFull')
    ...
    .addItem('M07 — Run AppSheet Live Bridge Test', 'menuCbvTestConsoleMilestone07_runFull')
    .addItem('Copy Milestone 07 Latest Test Report', 'menuCbvTestConsoleMilestone07_copyReport')
    .addItem('M08 — Run Operational State Runtime Test', 'menuCbvTestConsoleMilestone08_runFull')
    .addItem('Copy Milestone 08 Latest Test Report', 'menuCbvTestConsoleMilestone08_copyReport')
    .addItem('M09 — Run Interactive Task Runtime Test', 'menuCbvTestConsoleMilestone09_runFull')
    .addItem('Copy Milestone 09 Latest Test Report', 'menuCbvTestConsoleMilestone09_copyReport')
    .addItem('Run RF_02 Workboard Core Health Test', 'menuCbvTestConsoleRf02_runFull')
    .addItem('Copy RF_02 Latest Test Report', 'menuCbvTestConsoleRf02_copyReport')
    .addItem('Run RF_03 Operational Coordination Health Test', 'menuCbvTestConsoleRf03_runFull')
    ...
    .addItem('Run RF_07 Runtime Lock Verification', 'menuCbvTestConsoleRf07_runFull')
    .addItem('Copy RF_07 Latest Test Report', 'menuCbvTestConsoleRf07_copyReport')
