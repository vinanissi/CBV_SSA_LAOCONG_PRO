...
| 12 | 03_SHARED_FILE_HELPER.gs | SHARED | — |
| 13 | 01_ENUM_ADMIN_SERVICE.gs | ADMIN | 01_ENUM_*, 03_SHARED_* |
| 14 | 02_MASTER_CODE_ADMIN_SERVICE.gs | ADMIN | 02_MASTER_CODE, 01_ENUM, 03_SHARED_* |
| 15 | 03_ADMIN_AUDIT_SERVICE.gs | ADMIN | 03_SHARED_LOGGER |
| 16 | 90_BOOTSTRAP_SCHEMA.gs | BOOTSTRAP | — (manifest only) |
| 17 | 10_HOSO_SERVICE.gs | MODULES | 00_CORE_CONFIG, 03_SHARED_*, 01_ENUM_SERVICE |
| 18 | 20_TASK_SERVICE.gs | MODULES | 00_CORE_CONFIG, 03_SHARED_*, 01_ENUM_SERVICE |
| 19 | 30_FINANCE_SERVICE.gs | MODULES | 00_CORE_CONFIG, 03_SHARED_*, 01_ENUM_SERVICE |
| 20 | 40_DISPLAY_MAPPING_SERVICE.gs | DISPLAY | 01_ENUM_*, 02_MASTER_CODE_SERVICE |
| 21 | 90_BOOTSTRAP_INIT.gs | BOOTSTRAP | 90_BOOTSTRAP_SCHEMA, 01_ENUM_SEED, 40_DISPLAY |
| 22 | 90_BOOTSTRAP_AUDIT.gs | BOOTSTRAP | 90_BOOTSTRAP_SCHEMA, 00_CORE_UTILS |
| 23 | 50_APPSHEET_VERIFY.gs | APPSHEET | 90_BOOTSTRAP_AUDIT, 90_BOOTSTRAP_SCHEMA |
| 24 | 99_DEBUG_TEST_HOSO.gs | DEBUG | 10_HOSO_SERVICE |
| 25 | 99_DEBUG_TEST_TASK.gs | DEBUG | 20_TASK_SERVICE |
| 26 | 99_DEBUG_TEST_FINANCE.gs | DEBUG | 30_FINANCE_SERVICE |
| 27 | 99_DEBUG_TEST_RUNNER.gs | DEBUG | 99_DEBUG_TEST_* |
| 28 | 99_DEBUG_SAMPLE_DATA.gs | DEBUG | 10, 20, 30 |
| 29 | 90_BOOTSTRAP_MENU.gs | BOOTSTRAP | initAll, installTriggers, runAllModuleTests, seedGoldenDataset, verifyAppSheetReadiness, auditSystem |
| 30 | 90_BOOTSTRAP_TRIGGER.gs | BOOTSTRAP | — |
| 31 | 90_BOOTSTRAP_INSTALL.gs | BOOTSTRAP | 00_CORE_UTILS |
