...
function CbvWebAppWorkspace_routeRegistry() {
  var routes = [
    ...
    },
    {
      ...
      screenCode: 'RF05_PLUGIN_HOME',
      title: 'Plugin Workboard',
      pageType: CBV_WEBAPP_WS_PAGE_TYPES.RF05_PLUGIN_HOME,
      requiredRole: '*',
      dataSourceSheet: CBV_WEBAPP_WS_SHEETS.HOME_ALERT,
      mode: CBV_WEBAPP_WS_MODES.READ_FIRST,
      isEnabled: true,
      isPilotReady: true,
      notes: 'PHASE_RF_05 plugin registry workboard.'
    },
    {
      route: '/workspace/plugins/task',
      screenCode: 'RF05_PLUGIN_TASK',
      title: 'Task Plugin',
      pageType: CBV_WEBAPP_WS_PAGE_TYPES.RF05_PLUGIN_TASK,
      requiredRole: '*',
      dataSourceSheet: CBV_WEBAPP_WS_SHEETS.HOME_ALERT,
      mode: CBV_WEBAPP_WS_MODES.READ_FIRST,
      isEnabled: true,
      isPilotReady: true,
      notes: 'PHASE_RF_05 TASK plugin detail.'
    },
    {
      route: '/workspace/plugins/finance',
      screenCode: 'RF05_PLUGIN_FINANCE',
      title: 'Finance Plugin',
      pageType: CBV_WEBAPP_WS_PAGE_TYPES.RF05_PLUGIN_FINANCE,
      requiredRole: '*',
      dataSourceSheet: CBV_WEBAPP_WS_SHEETS.HOME_ALERT,
      mode: CBV_WEBAPP_WS_MODES.READ_FIRST,
      isEnabled: true,
      isPilotReady: true,
      notes: 'PHASE_RF_05 FINANCE plugin stub.'
    },
    {
      route: '/workspace/plugins/ho-so',
      screenCode: 'RF05_PLUGIN_HO_SO',
      title: 'Hồ sơ Plugin',
      pageType: CBV_WEBAPP_WS_PAGE_TYPES.RF05_PLUGIN_HO_SO,
      requiredRole: '*',
      dataSourceSheet: CBV_WEBAPP_WS_SHEETS.HOME_ALERT,
      mode: CBV_WEBAPP_WS_MODES.READ_FIRST,
      isEnabled: true,
    ...
    },
    {
      ...
      title: 'Plugin Health',
      pageType: CBV_WEBAPP_WS_PAGE_TYPES.RF05_PLUGIN_HEALTH,
      requiredRole: '*',
      dataSourceSheet: CBV_WEBAPP_WS_SHEETS.HOME_ALERT,
      mode: CBV_WEBAPP_WS_MODES.READ_FIRST,
      isEnabled: true,
      isPilotReady: true,
      notes: 'PHASE_RF_05 plugin observation health.'
    },
    {
      route: '/workboard/plugins',
      screenCode: 'RF05_PLUGIN_HOME_ALIAS',
      title: 'Plugins',
      pageType: CBV_WEBAPP_WS_PAGE_TYPES.RF05_PLUGIN_HOME,
      requiredRole: '*',
      dataSourceSheet: CBV_WEBAPP_WS_SHEETS.HOME_ALERT,
      ...
      isEnabled: true,
      isPilotReady: true,
      notes: 'Alias RF_05 plugins.'
    },
    {
      route: '/workboard/plugin-task',
      screenCode: 'RF05_PLUGIN_TASK_ALIAS',
      title: 'Task Plugin',
      pageType: CBV_WEBAPP_WS_PAGE_TYPES.RF05_PLUGIN_TASK,
      requiredRole: '*',
      dataSourceSheet: CBV_WEBAPP_WS_SHEETS.HOME_ALERT,
      ...
      isEnabled: true,
      isPilotReady: true,
      notes: 'Alias RF_05 task plugin.'
    },
    {
      route: '/workboard/plugin-finance',
      screenCode: 'RF05_PLUGIN_FINANCE_ALIAS',
      title: 'Finance Plugin',
      pageType: CBV_WEBAPP_WS_PAGE_TYPES.RF05_PLUGIN_FINANCE,
      requiredRole: '*',
      dataSourceSheet: CBV_WEBAPP_WS_SHEETS.HOME_ALERT,
      ...
      isEnabled: true,
      isPilotReady: true,
      notes: 'Alias RF_05 finance plugin.'
    },
    {
      route: '/workboard/plugin-ho-so',
      screenCode: 'RF05_PLUGIN_HO_SO_ALIAS',
      title: 'Hồ sơ Plugin',
      pageType: CBV_WEBAPP_WS_PAGE_TYPES.RF05_PLUGIN_HO_SO,
      requiredRole: '*',
      dataSourceSheet: CBV_WEBAPP_WS_SHEETS.HOME_ALERT,
      ...
      isEnabled: true,
      isPilotReady: true,
      notes: 'Alias RF_05 ho-so plugin.'
    },
    {
