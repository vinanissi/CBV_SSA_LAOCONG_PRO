...
function CbvWebAppRouteUrl_TestConsole_run() {
  ...
  try {
    ...
    var okVi = Array.isArray(navVi) && navVi.length === 8 && navVi[0].url && navVi[0].url.indexOf('https://') === 0;
    addCheck('NAV_VI_ABSOLUTE', okVi, okVi ? 'OK' : 'ERROR', 'Vietnamese nav has 8 absolute https URLs.', { first: navVi && navVi[0] ? navVi[0].url : '' });
  } catch (eN) {
