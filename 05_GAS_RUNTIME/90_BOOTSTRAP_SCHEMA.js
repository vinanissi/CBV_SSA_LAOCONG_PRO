...
// ===== HẾT PHẦN DÁN =====
  ...
  /** Một dòng / user: chọn chu kỳ + đơn vị + người (CREATED_BY) trước khi export CSV từ AppSheet */
  FIN_EXPORT_FILTER: ['ID', 'USER_EMAIL', 'DATE_FROM', 'DATE_TO', 'DON_VI_ID', 'USER_REF_ID', 'NOTE', 'UPDATED_AT'],
  FINANCE_LOG: ['ID', 'FIN_ID', 'ACTION', 'BEFORE_JSON', 'AFTER_JSON', 'NOTE', 'ACTOR_ID', 'CREATED_AT'],

  /** Event-driven core — append-only; processed by 04_CORE_EVENT_PROCESSOR.js */
  EVENT_QUEUE: [
    'ID',
    'EVENT_TYPE',
    'SOURCE_MODULE',
  ...
  /** Rule rows — CONDITION_JSON / ACTIONS_JSON evaluated by 04_CORE_RULE_ENGINE.js */
  RULE_DEF: [
    'ID',
    'RULE_CODE',
    'PRIORITY',
