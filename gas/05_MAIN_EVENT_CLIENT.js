 ...
 * Copy file này vào project Apps Script của module con (TASK / FINANCE / HO_SO).
 * Không đọc/ghi sheet MAIN; không phụ thuộc response.
 *
 * ScriptProperties:
 *   MAIN_EVENT_ENABLED, MAIN_EVENT_WEBHOOK_URL, MAIN_EVENT_SOURCE_MODULE
 *
 * Payload chuẩn trong body.payload:
