...
**Date:** 2025-03-21  
**Scope:** APPSHEET_TASK_FIELD_POLICY.md, APPSHEET_TASK_ACTION_RULES.md, 20_TASK_SERVICE.js, 20_TASK_VALIDATION.js
...
| GAS: updateTask blocks STATUS | 20_TASK_SERVICE.js:123-126 `blocked = ['STATUS', 'DONE_AT', 'PROGRESS_PERCENT']` |
| Only paths: setTaskStatus, assignTask, completeTask, cancelTask | 20_TASK_SERVICE.js |
| validateTaskTransition blocks invalid transitions | 20_TASK_VALIDATION.js |
...
| GAS: updateTask strips DONE_AT | 20_TASK_SERVICE.js:123-126 |
| Only setter: completeTask | 20_TASK_SERVICE.js:201-202 `patch.DONE_AT = cbvNow()` |
