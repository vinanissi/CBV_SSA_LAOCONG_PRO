...
**Related:** 03_SHARED/USER_TASK_FINANCE_MAPPING.md, 04_APPSHEET/APPSHEET_USER_LAYER.md, 05_GAS_RUNTIME/03_USER_MIGRATION_HELPER.js
...
| 0.2 | Run `analyzeUserRefValues()` from 03_USER_MIGRATION_HELPER.js | Report of current value distribution |
...
- 02_USER_SERVICE.js (getUserByEmail, getUserById)
- CBV_CONFIG.SHEETS.*
