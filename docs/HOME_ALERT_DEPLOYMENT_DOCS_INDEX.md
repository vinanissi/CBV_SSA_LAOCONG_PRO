...
| `05_GAS_RUNTIME/998M_TEST_ARTIFACT_REGISTRY_RUNTIME.js` | Registry sheet + mirrors + `registerExportResult` |
| `05_GAS_RUNTIME/998N_TEST_ARTIFACT_REGISTRY_TEST_CONSOLE.js` | Test Console Phase 97.2 (CBV_TCS_V1) |
| `docs/test-console/CBV_TCS_ARTIFACT_REGISTRY_V1.md` | Đặc tả registry |
| `docs/test-console/CBV_TCS_MARKDOWN_MIRROR_STANDARD_V1.md` | Chuẩn Markdown mirror |
| `00_SYSTEM_BRAIN/000_PROMPTS/097_2_TEST_ARTIFACT_REGISTRY_MARKDOWN_MIRROR_PROMPT.md` | Prompt archive |
| `00_SYSTEM_BRAIN/000_REPORTS/097_2_TEST_ARTIFACT_REGISTRY_MARKDOWN_MIRROR_REPORT.md` | Report |
| `00_SYSTEM_BRAIN/001_HANDOFF/097_2_TEST_ARTIFACT_REGISTRY_MARKDOWN_MIRROR_HANDOFF.md` | Handoff |
| `00_SYSTEM_BRAIN/002_DECISIONS/097_2_TEST_ARTIFACT_REGISTRY_DECISION_LOG.md` | Decision log |
...
**Artifacts:** `097_*`, `097_1_*`, `097_2_*` trong `00_SYSTEM_BRAIN/`.  
