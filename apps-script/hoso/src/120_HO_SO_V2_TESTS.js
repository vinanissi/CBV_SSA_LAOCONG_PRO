...
/**
 * @returns {Object} same shape as HoSoV2_selfTest (menu/admin alias).
 */
function HosoService_selfTest() {
  return HoSoV2_selfTest();
}

/**
 * Debug: library `CBVCoreRuntime` có expose top-level `dispatch` / `bootstrap` hay không.
 * @returns {Object}
 */
function test_CoreLib_Debug() {
  var result = {
    hasLib: typeof CBVCoreRuntime !== 'undefined',
    hasLibraryDispatch: typeof CBVCoreRuntime !== 'undefined' && typeof CBVCoreRuntime.dispatch === 'function',
    hasHostDispatch: typeof CBV_CoreV2_dispatch === 'function',
    hasBootstrap: typeof CBVCoreRuntime !== 'undefined' && typeof CBVCoreRuntime.bootstrap === 'function',
    typeOfLib: typeof CBVCoreRuntime,
    keys: typeof CBVCoreRuntime !== 'undefined' ? Object.keys(CBVCoreRuntime) : []
  };
