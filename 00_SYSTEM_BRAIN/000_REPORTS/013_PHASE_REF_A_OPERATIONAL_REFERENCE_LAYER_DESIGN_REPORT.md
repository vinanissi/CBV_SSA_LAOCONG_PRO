...
Clean on `phase/from-v2.4.1-TASK-FIN` at tip `9555aad`.

## COMMIT / PUSH / TAG STATUS

- **Commits:** `d06f09c` — `feat(reference): add operational reference layer`; `d47d78e` — `docs(report): correct REF-A delivered commit hash`; `9555aad` — `docs(report): document REF-A feature and follow-up commit shas`
