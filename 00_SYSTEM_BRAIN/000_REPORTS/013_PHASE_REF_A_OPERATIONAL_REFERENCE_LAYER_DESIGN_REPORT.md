...
Clean on `phase/from-v2.4.1-TASK-FIN` at tip `d47d78e`.

## COMMIT / PUSH / TAG STATUS

- **Commits:** `d06f09c` — `feat(reference): add operational reference layer`; `d47d78e` — `docs(report): correct REF-A delivered commit hash`
