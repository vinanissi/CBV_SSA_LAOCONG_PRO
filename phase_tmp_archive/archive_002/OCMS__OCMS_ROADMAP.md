...
**Status:** Planning (no implementation in foundation phases)  
**ADR:** `ADR_OCMS_FOUNDATION.md`, `ADR_OCMS_FOUNDATION_CRM_ADDENDUM.md`, `ADR_OCMS_CASE_TYPE_RESULT_ADDENDUM.md`, `ADR_OCMS_CASE_LIFECYCLE_ADDENDUM.md`
...
| **OCMS_02** `PHASE_OCMS_02_READ_MODEL_CONTRACT` | DOC-ONLY | API/UI contract for read-only Case shell | None | Spec only |
...
Phases **00A, 01, 01A, 01B, 02** can run as DOC-ONLY in parallel with Work Inbox runtime phases.
