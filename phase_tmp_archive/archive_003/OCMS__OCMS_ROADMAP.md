...
**ADR:** `ADR_OCMS_FOUNDATION.md`, `ADR_OCMS_FOUNDATION_CRM_ADDENDUM.md`, `ADR_OCMS_CASE_TYPE_RESULT_ADDENDUM.md`, `ADR_OCMS_CASE_LIFECYCLE_ADDENDUM.md`, `ADR_OCMS_CASE_RELATION_ADDENDUM.md`
