...
**Status:** Planning (strip visibility + layout ready for OCMS_03)  
...
Phases **00A, 01, 01A, 01B, 01C, 02, 02A, 02B, 02C** can run as DOC-ONLY in parallel with Work Inbox runtime phases.
