...
**ADR:** `ADR_OCMS_FOUNDATION.md`, `ADR_OCMS_FOUNDATION_CRM_ADDENDUM.md`, `ADR_OCMS_CASE_TYPE_RESULT_ADDENDUM.md`
...
Phases **00A, 01, 01A, 02** can run as DOC-ONLY in parallel with Work Inbox runtime phases.
