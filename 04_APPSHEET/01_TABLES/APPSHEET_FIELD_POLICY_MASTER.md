...
- Applies to: TRANS_CODE, TRANS_DATE, TRANS_TYPE, CATEGORY, AMOUNT, UNIT_ID, COUNTERPARTY, PAYMENT_METHOD, REFERENCE_NO, RELATED_ENTITY_TYPE, RELATED_ENTITY_ID, DESCRIPTION, EVIDENCE_URL
