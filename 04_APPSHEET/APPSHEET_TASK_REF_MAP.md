...
|--------|------------|----------|---------|------------|
| HTX_ID | ACTIVE_HTX | `IN([HTX_ID], SELECT(HO_SO_MASTER[ID], AND([HO_SO_TYPE_ID].[CODE] = "HTX", [IS_DELETED] = FALSE)))` | NAME | OFF |
...
- Source: HO_SO_MASTER
- Filter: `AND([HO_SO_TYPE_ID].[CODE] = "HTX", [IS_DELETED] = FALSE)`
- Label column: NAME
