...
|------|-------|------------------------|
| HO_SO_DETAIL | HO_SO_MASTER | NAME, CODE, HO_SO_TYPE, STATUS, HTX_ID, OWNER_ID, PHONE, EMAIL, ID_NO, ADDRESS, START_DATE, END_DATE, NOTE, TAGS |
| HO_SO_FORM | HO_SO_MASTER | HO_SO_TYPE, CODE, NAME, HTX_ID, OWNER_ID, PHONE, EMAIL, ID_NO, ADDRESS, START_DATE, END_DATE, NOTE, TAGS, STATUS |
| TASK_DETAIL | TASK_MAIN | TITLE, TASK_CODE, TASK_TYPE, STATUS, PRIORITY, OWNER_ID, REPORTER_ID, RELATED_*, START_DATE, DUE_DATE, DONE_AT, RESULT_NOTE, DESCRIPTION |
| TASK_FORM | TASK_MAIN | TASK_TYPE, TITLE, TASK_CODE, PRIORITY, OWNER_ID, REPORTER_ID, RELATED_*, START_DATE, DUE_DATE, DESCRIPTION, RESULT_NOTE, STATUS |
| FINANCE_DETAIL | FINANCE_TRANSACTION | TRANS_CODE, TRANS_DATE, TRANS_TYPE, STATUS, CATEGORY, AMOUNT, UNIT_ID, COUNTERPARTY, PAYMENT_METHOD, REFERENCE_NO, RELATED_*, DESCRIPTION, EVIDENCE_URL |
| FINANCE_FORM | FINANCE_TRANSACTION | TRANS_TYPE, TRANS_DATE, CATEGORY, AMOUNT, UNIT_ID, COUNTERPARTY, PAYMENT_METHOD, REFERENCE_NO, RELATED_*, DESCRIPTION, EVIDENCE_URL, TRANS_CODE, STATUS |
